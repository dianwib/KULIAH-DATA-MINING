...
class SampleWindow(QWidget):
    ...
    def SetLayout(self):
        ...
        self.x1text=QLabel("")
        self.x2text = QLabel("Massukkan banyak cluster tadi ketika proses fuzzy c-mean")
    ...
    def cek(self):
        ...
        self.data = excel.sheet_by_index(2)
        ...
        self.excel_baru.save("tribunnews_silhout_cmean.xlsx")
